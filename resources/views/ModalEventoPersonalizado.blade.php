...
<body>
    ...
    <div id="openModal" class="modalDialog">
        <div>
            ...
            <h2 class="h2 font-weight-bold" style="margin-top=4rem; text-align: center;">Lo sentimos, no es posible organizar dicho evento</h2>
            <p class="font-italic text-muted">Puede que la pista ya este reservada para ese dia</p>
        </div>
    </div>
